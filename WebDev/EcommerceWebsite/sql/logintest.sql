...
(1, '2023 Canyon Aeroad CF SLX 7 Disc Etap', 0, 'Bike1.JPG', '262505', 'Experience the incredible speed of a road race bike with world-class aerodynamics. With a newly developed, super-clean aero frame and integrated cockpit, this bike saves watts every time you turn the crank, so you can go faster and attack the field even h', 50),
(3, '2023 Canyon LUX World Cup CF 7', 0, 'bikeshop2.png', ' 305000', 'Instant acceleration, high top speed, precise handling: the Lux World Cup 7 comes into its own on techy climbs and is lightning fast when you’re sprinting to the line. Ready to race? Then you just might have found your perfect bike.', 50),
...
(7, 'deez', 'deez', 'deez', 'deez', 'deez', '$2y$10$064yvA5P/VJOYJzrKJkZIuLu4DyrgAtdcMzfZcmV2KupYyE34Oms2', 0, ''),
(8, 'deez', 'deez', 'deez', 'deez', 'deez', '$2y$10$064yvA5P/VJOYJzrKJkZIuLu4DyrgAtdcMzfZcmV2KupYyE34Oms2', 0, '');
